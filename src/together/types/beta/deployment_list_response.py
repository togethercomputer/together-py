...
__all__ = [
    ...
    "DataReplicaEvents",
    "DataReplicaEventsContainerStatus",
    "DataReplicaEventsEvent",
    "DataVolume",
]


class DataEnvironmentVariable(BaseModel):
    name: str
...
class DataReplicaEventsContainerStatus(BaseModel):
    """
...
class DataReplicaEventsEvent(BaseModel):
...
class DataReplicaEvents(BaseModel):
    container_status: Optional[DataReplicaEventsContainerStatus] = None
    """
    ContainerStatus provides detailed status information about the container within
    this replica
    """

    events: Optional[List[DataReplicaEventsEvent]] = None
    """
...
class Data(BaseModel):
    ...
    environment_variables: Optional[List[DataEnvironmentVariable]] = None
    ...
    replica_events: Optional[Dict[str, DataReplicaEvents]] = None
    ...
    volumes: Optional[List[DataVolume]] = None
