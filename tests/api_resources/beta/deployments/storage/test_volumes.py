...
class TestVolumes:
    ...
    def test_raw_response_create(self, client: Together) -> None:
        response = client.beta.deployments.storage.volumes.with_raw_response.create(
            content={},
            name="name",
            type="readOnly",
        )
    ...
    def test_streaming_response_create(self, client: Together) -> None:
        with client.beta.deployments.storage.volumes.with_streaming_response.create(
            content={},
            name="name",
            type="readOnly",
        ) as response:
    ...
    def test_method_retrieve(self, client: Together) -> None:
        volume = client.beta.deployments.storage.volumes.retrieve(
            "id",
        )
    ...
    def test_raw_response_retrieve(self, client: Together) -> None:
        response = client.beta.deployments.storage.volumes.with_raw_response.retrieve(
            "id",
        )
    ...
    def test_streaming_response_retrieve(self, client: Together) -> None:
        with client.beta.deployments.storage.volumes.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: Together) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.beta.deployments.storage.volumes.with_raw_response.retrieve(
                "",
            )

    @parametrize
    def test_method_update(self, client: Together) -> None:
        volume = client.beta.deployments.storage.volumes.update(
            id="id",
        )
    ...
    def test_raw_response_update(self, client: Together) -> None:
        response = client.beta.deployments.storage.volumes.with_raw_response.update(
            id="id",
        )
    ...
    def test_streaming_response_update(self, client: Together) -> None:
        with client.beta.deployments.storage.volumes.with_streaming_response.update(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_update(self, client: Together) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.beta.deployments.storage.volumes.with_raw_response.update(
                id="",
            )

    @parametrize
    def test_method_list(self, client: Together) -> None:
        volume = client.beta.deployments.storage.volumes.list()
        assert_matches_type(VolumeListResponse, volume, path=["response"])

    @parametrize
    def test_raw_response_list(self, client: Together) -> None:
        response = client.beta.deployments.storage.volumes.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Together) -> None:
        with client.beta.deployments.storage.volumes.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_delete(self, client: Together) -> None:
        volume = client.beta.deployments.storage.volumes.delete(
            "id",
        )
    ...
    def test_raw_response_delete(self, client: Together) -> None:
        response = client.beta.deployments.storage.volumes.with_raw_response.delete(
            "id",
        )
    ...
    def test_streaming_response_delete(self, client: Together) -> None:
        with client.beta.deployments.storage.volumes.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: Together) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.beta.deployments.storage.volumes.with_raw_response.delete(
                "",
            )
...
class TestAsyncVolumes:
    ...
    async def test_method_create(self, async_client: AsyncTogether) -> None:
        volume = await async_client.beta.deployments.storage.volumes.create(
            content={},
            name="name",
            type="readOnly",
        )
    ...
    async def test_raw_response_create(self, async_client: AsyncTogether) -> None:
        response = await async_client.beta.deployments.storage.volumes.with_raw_response.create(
            content={},
            name="name",
            type="readOnly",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncTogether) -> None:
        async with async_client.beta.deployments.storage.volumes.with_streaming_response.create(
            content={},
            name="name",
            type="readOnly",
        ) as response:
    ...
    async def test_method_retrieve(self, async_client: AsyncTogether) -> None:
        volume = await async_client.beta.deployments.storage.volumes.retrieve(
            "id",
        )
        assert_matches_type(VolumeRetrieveResponse, volume, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncTogether) -> None:
        response = await async_client.beta.deployments.storage.volumes.with_raw_response.retrieve(
            "id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncTogether) -> None:
        async with async_client.beta.deployments.storage.volumes.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncTogether) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.beta.deployments.storage.volumes.with_raw_response.retrieve(
                "",
            )

    @parametrize
    async def test_method_update(self, async_client: AsyncTogether) -> None:
        volume = await async_client.beta.deployments.storage.volumes.update(
            id="id",
        )
        assert_matches_type(VolumeUpdateResponse, volume, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncTogether) -> None:
        response = await async_client.beta.deployments.storage.volumes.with_raw_response.update(
            id="id",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncTogether) -> None:
        async with async_client.beta.deployments.storage.volumes.with_streaming_response.update(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_update(self, async_client: AsyncTogether) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.beta.deployments.storage.volumes.with_raw_response.update(
                id="",
            )

    @parametrize
    async def test_method_list(self, async_client: AsyncTogether) -> None:
        volume = await async_client.beta.deployments.storage.volumes.list()
        assert_matches_type(VolumeListResponse, volume, path=["response"])

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncTogether) -> None:
        response = await async_client.beta.deployments.storage.volumes.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncTogether) -> None:
        async with async_client.beta.deployments.storage.volumes.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncTogether) -> None:
        volume = await async_client.beta.deployments.storage.volumes.delete(
            "id",
        )
        assert_matches_type(object, volume, path=["response"])
    ...
    async def test_raw_response_delete(self, async_client: AsyncTogether) -> None:
        response = await async_client.beta.deployments.storage.volumes.with_raw_response.delete(
            "id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncTogether) -> None:
        async with async_client.beta.deployments.storage.volumes.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncTogether) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.beta.deployments.storage.volumes.with_raw_response.delete(
                "",
            )
