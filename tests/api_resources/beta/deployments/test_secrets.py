...
class TestSecrets:
    ...
    def test_method_create(self, client: Together) -> None:
        secret = client.beta.deployments.secrets.create(
            name="x",
            value="x",
        )
    ...
    def test_raw_response_create(self, client: Together) -> None:
        response = client.beta.deployments.secrets.with_raw_response.create(
            name="x",
            value="x",
        )
    ...
    def test_streaming_response_create(self, client: Together) -> None:
        with client.beta.deployments.secrets.with_streaming_response.create(
            name="x",
            value="x",
        ) as response:
    ...
    def test_method_retrieve(self, client: Together) -> None:
        secret = client.beta.deployments.secrets.retrieve(
            "id",
        )
    ...
    def test_raw_response_retrieve(self, client: Together) -> None:
        response = client.beta.deployments.secrets.with_raw_response.retrieve(
            "id",
        )
    ...
    def test_streaming_response_retrieve(self, client: Together) -> None:
        with client.beta.deployments.secrets.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: Together) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.beta.deployments.secrets.with_raw_response.retrieve(
                "",
            )

    @parametrize
    def test_method_update(self, client: Together) -> None:
        secret = client.beta.deployments.secrets.update(
            id="id",
        )
    ...
    def test_raw_response_update(self, client: Together) -> None:
        response = client.beta.deployments.secrets.with_raw_response.update(
            id="id",
        )
    ...
    def test_streaming_response_update(self, client: Together) -> None:
        with client.beta.deployments.secrets.with_streaming_response.update(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_update(self, client: Together) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.beta.deployments.secrets.with_raw_response.update(
                id="",
            )

    @parametrize
    def test_method_list(self, client: Together) -> None:
        secret = client.beta.deployments.secrets.list()
        assert_matches_type(SecretListResponse, secret, path=["response"])

    @parametrize
    def test_raw_response_list(self, client: Together) -> None:
        response = client.beta.deployments.secrets.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Together) -> None:
        with client.beta.deployments.secrets.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_delete(self, client: Together) -> None:
        secret = client.beta.deployments.secrets.delete(
            "id",
        )
    ...
    def test_raw_response_delete(self, client: Together) -> None:
        response = client.beta.deployments.secrets.with_raw_response.delete(
            "id",
        )
    ...
    def test_streaming_response_delete(self, client: Together) -> None:
        with client.beta.deployments.secrets.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: Together) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.beta.deployments.secrets.with_raw_response.delete(
                "",
            )
...
class TestAsyncSecrets:
    ...
    async def test_method_create(self, async_client: AsyncTogether) -> None:
        secret = await async_client.beta.deployments.secrets.create(
            name="x",
            value="x",
        )
        assert_matches_type(SecretCreateResponse, secret, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncTogether) -> None:
        response = await async_client.beta.deployments.secrets.with_raw_response.create(
            name="x",
            value="x",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncTogether) -> None:
        async with async_client.beta.deployments.secrets.with_streaming_response.create(
            name="x",
            value="x",
        ) as response:
            assert not response.is_closed
    ...
    async def test_method_retrieve(self, async_client: AsyncTogether) -> None:
        secret = await async_client.beta.deployments.secrets.retrieve(
            "id",
        )
        assert_matches_type(SecretRetrieveResponse, secret, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncTogether) -> None:
        response = await async_client.beta.deployments.secrets.with_raw_response.retrieve(
            "id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncTogether) -> None:
        async with async_client.beta.deployments.secrets.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncTogether) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.beta.deployments.secrets.with_raw_response.retrieve(
                "",
            )

    @parametrize
    async def test_method_update(self, async_client: AsyncTogether) -> None:
        secret = await async_client.beta.deployments.secrets.update(
            id="id",
        )
        assert_matches_type(SecretUpdateResponse, secret, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncTogether) -> None:
        response = await async_client.beta.deployments.secrets.with_raw_response.update(
            id="id",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncTogether) -> None:
        async with async_client.beta.deployments.secrets.with_streaming_response.update(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_update(self, async_client: AsyncTogether) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.beta.deployments.secrets.with_raw_response.update(
                id="",
            )

    @parametrize
    async def test_method_list(self, async_client: AsyncTogether) -> None:
        secret = await async_client.beta.deployments.secrets.list()
        assert_matches_type(SecretListResponse, secret, path=["response"])

    @parametrize
    async def test_raw_response_list(self, async_client: AsyncTogether) -> None:
        response = await async_client.beta.deployments.secrets.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncTogether) -> None:
        async with async_client.beta.deployments.secrets.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncTogether) -> None:
        secret = await async_client.beta.deployments.secrets.delete(
            "id",
        )
        assert_matches_type(object, secret, path=["response"])
    ...
    async def test_raw_response_delete(self, async_client: AsyncTogether) -> None:
        response = await async_client.beta.deployments.secrets.with_raw_response.delete(
            "id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncTogether) -> None:
        async with async_client.beta.deployments.secrets.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncTogether) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.beta.deployments.secrets.with_raw_response.delete(
                "",
            )
