...
from together.types.beta import Cluster
...
class TestEndpoints:
    ...
    @parametrize
    def test_method_create_cluster(self, client: Together) -> None:
        endpoint = client.endpoints.create_cluster(
        ...
        assert_matches_type(EndpointCreateClusterResponse, endpoint, path=["response"])

    @parametrize
    def test_method_create_cluster_with_all_params(self, client: Together) -> None:
        endpoint = client.endpoints.create_cluster(
            billing_type="RESERVED",
            cluster_name="cluster_name",
            driver_version="CUDA_12_5_555",
    ...
    @parametrize
    def test_raw_response_create_cluster(self, client: Together) -> None:
        response = client.endpoints.with_raw_response.create_cluster(
            billing_type="RESERVED",
            cluster_name="cluster_name",
            driver_version="CUDA_12_5_555",
            duration_days=0,
    ...
    @parametrize
    def test_streaming_response_create_cluster(self, client: Together) -> None:
        with client.endpoints.with_streaming_response.create_cluster(
            billing_type="RESERVED",
            cluster_name="cluster_name",
            driver_version="CUDA_12_5_555",
            duration_days=0,
    ...
    @parametrize
    def test_method_delete_cluster(self, client: Together) -> None:
        endpoint = client.endpoints.delete_cluster(
            "cluster_id",
        )
        assert_matches_type(EndpointDeleteClusterResponse, endpoint, path=["response"])

    @parametrize
    def test_raw_response_delete_cluster(self, client: Together) -> None:
        response = client.endpoints.with_raw_response.delete_cluster(
            "cluster_id",
        )
    ...
    @parametrize
    def test_streaming_response_delete_cluster(self, client: Together) -> None:
        with client.endpoints.with_streaming_response.delete_cluster(
            "cluster_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    def test_path_params_delete_cluster(self, client: Together) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `cluster_id` but received ''"):
            client.endpoints.with_raw_response.delete_cluster(
                "",
            )
    ...
    @parametrize
    def test_method_list_clusters(self, client: Together) -> None:
        endpoint = client.endpoints.list_clusters()
        assert_matches_type(EndpointListClustersResponse, endpoint, path=["response"])

    @parametrize
    def test_raw_response_list_clusters(self, client: Together) -> None:
        response = client.endpoints.with_raw_response.list_clusters()
    ...
    @parametrize
    def test_streaming_response_list_clusters(self, client: Together) -> None:
        with client.endpoints.with_streaming_response.list_clusters() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_list_regions(self, client: Together) -> None:
        endpoint = client.endpoints.list_regions()
        assert_matches_type(EndpointListRegionsResponse, endpoint, path=["response"])

    @parametrize
    def test_raw_response_list_regions(self, client: Together) -> None:
        response = client.endpoints.with_raw_response.list_regions()
    ...
    def test_streaming_response_list_regions(self, client: Together) -> None:
        with client.endpoints.with_streaming_response.list_regions() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    def test_method_retrieve_cluster(self, client: Together) -> None:
        endpoint = client.endpoints.retrieve_cluster(
            "cluster_id",
        )
        assert_matches_type(Cluster, endpoint, path=["response"])

    @parametrize
    def test_raw_response_retrieve_cluster(self, client: Together) -> None:
        response = client.endpoints.with_raw_response.retrieve_cluster(
            "cluster_id",
        )
    ...
    @parametrize
    def test_streaming_response_retrieve_cluster(self, client: Together) -> None:
        with client.endpoints.with_streaming_response.retrieve_cluster(
            "cluster_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    def test_path_params_retrieve_cluster(self, client: Together) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `cluster_id` but received ''"):
            client.endpoints.with_raw_response.retrieve_cluster(
                "",
            )

    @parametrize
    def test_method_update_cluster(self, client: Together) -> None:
        endpoint = client.endpoints.update_cluster(
            cluster_id="cluster_id",
        )
        assert_matches_type(EndpointUpdateClusterResponse, endpoint, path=["response"])

    @parametrize
    def test_method_update_cluster_with_all_params(self, client: Together) -> None:
        endpoint = client.endpoints.update_cluster(
            cluster_id="cluster_id",
            cluster_type="KUBERNETES",
            num_gpus=0,
    ...
    @parametrize
    def test_raw_response_update_cluster(self, client: Together) -> None:
        response = client.endpoints.with_raw_response.update_cluster(
            cluster_id="cluster_id",
        )
    ...
    @parametrize
    def test_streaming_response_update_cluster(self, client: Together) -> None:
        with client.endpoints.with_streaming_response.update_cluster(
            cluster_id="cluster_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    def test_path_params_update_cluster(self, client: Together) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `cluster_id` but received ''"):
            client.endpoints.with_raw_response.update_cluster(
                cluster_id="",
            )
...
class TestAsyncEndpoints:
    ...
    @parametrize
    async def test_method_create_cluster(self, async_client: AsyncTogether) -> None:
        endpoint = await async_client.endpoints.create_cluster(
            billing_type="RESERVED",
            cluster_name="cluster_name",
            driver_version="CUDA_12_5_555",
            duration_days=0,
    ...
    @parametrize
    async def test_method_create_cluster_with_all_params(self, async_client: AsyncTogether) -> None:
        endpoint = await async_client.endpoints.create_cluster(
            billing_type="RESERVED",
            cluster_name="cluster_name",
            driver_version="CUDA_12_5_555",
    ...
    @parametrize
    async def test_raw_response_create_cluster(self, async_client: AsyncTogether) -> None:
        response = await async_client.endpoints.with_raw_response.create_cluster(
            billing_type="RESERVED",
            cluster_name="cluster_name",
            driver_version="CUDA_12_5_555",
            duration_days=0,
    ...
    @parametrize
    async def test_streaming_response_create_cluster(self, async_client: AsyncTogether) -> None:
        async with async_client.endpoints.with_streaming_response.create_cluster(
            billing_type="RESERVED",
            cluster_name="cluster_name",
            driver_version="CUDA_12_5_555",
            duration_days=0,
    ...
    @parametrize
    async def test_method_delete_cluster(self, async_client: AsyncTogether) -> None:
        endpoint = await async_client.endpoints.delete_cluster(
            "cluster_id",
        )
        assert_matches_type(EndpointDeleteClusterResponse, endpoint, path=["response"])

    @parametrize
    async def test_raw_response_delete_cluster(self, async_client: AsyncTogether) -> None:
        response = await async_client.endpoints.with_raw_response.delete_cluster(
            "cluster_id",
        )
    ...
    @parametrize
    async def test_streaming_response_delete_cluster(self, async_client: AsyncTogether) -> None:
        async with async_client.endpoints.with_streaming_response.delete_cluster(
            "cluster_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    async def test_path_params_delete_cluster(self, async_client: AsyncTogether) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `cluster_id` but received ''"):
            await async_client.endpoints.with_raw_response.delete_cluster(
                "",
            )
    ...
    @parametrize
    async def test_method_list_clusters(self, async_client: AsyncTogether) -> None:
        endpoint = await async_client.endpoints.list_clusters()
        assert_matches_type(EndpointListClustersResponse, endpoint, path=["response"])

    @parametrize
    async def test_raw_response_list_clusters(self, async_client: AsyncTogether) -> None:
        response = await async_client.endpoints.with_raw_response.list_clusters()
    ...
    @parametrize
    async def test_streaming_response_list_clusters(self, async_client: AsyncTogether) -> None:
        async with async_client.endpoints.with_streaming_response.list_clusters() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_list_regions(self, async_client: AsyncTogether) -> None:
        endpoint = await async_client.endpoints.list_regions()
        assert_matches_type(EndpointListRegionsResponse, endpoint, path=["response"])

    @parametrize
    async def test_raw_response_list_regions(self, async_client: AsyncTogether) -> None:
        response = await async_client.endpoints.with_raw_response.list_regions()
    ...
    async def test_streaming_response_list_regions(self, async_client: AsyncTogether) -> None:
        async with async_client.endpoints.with_streaming_response.list_regions() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    async def test_method_retrieve_cluster(self, async_client: AsyncTogether) -> None:
        endpoint = await async_client.endpoints.retrieve_cluster(
            "cluster_id",
        )
        assert_matches_type(Cluster, endpoint, path=["response"])

    @parametrize
    async def test_raw_response_retrieve_cluster(self, async_client: AsyncTogether) -> None:
        response = await async_client.endpoints.with_raw_response.retrieve_cluster(
            "cluster_id",
        )
    ...
    @parametrize
    async def test_streaming_response_retrieve_cluster(self, async_client: AsyncTogether) -> None:
        async with async_client.endpoints.with_streaming_response.retrieve_cluster(
            "cluster_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    async def test_path_params_retrieve_cluster(self, async_client: AsyncTogether) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `cluster_id` but received ''"):
            await async_client.endpoints.with_raw_response.retrieve_cluster(
                "",
            )

    @parametrize
    async def test_method_update_cluster(self, async_client: AsyncTogether) -> None:
        endpoint = await async_client.endpoints.update_cluster(
            cluster_id="cluster_id",
        )
        assert_matches_type(EndpointUpdateClusterResponse, endpoint, path=["response"])

    @parametrize
    async def test_method_update_cluster_with_all_params(self, async_client: AsyncTogether) -> None:
        endpoint = await async_client.endpoints.update_cluster(
            cluster_id="cluster_id",
            cluster_type="KUBERNETES",
            num_gpus=0,
    ...
    @parametrize
    async def test_raw_response_update_cluster(self, async_client: AsyncTogether) -> None:
        response = await async_client.endpoints.with_raw_response.update_cluster(
            cluster_id="cluster_id",
        )
    ...
    @parametrize
    async def test_streaming_response_update_cluster(self, async_client: AsyncTogether) -> None:
        async with async_client.endpoints.with_streaming_response.update_cluster(
            cluster_id="cluster_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    async def test_path_params_update_cluster(self, async_client: AsyncTogether) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `cluster_id` but received ''"):
            await async_client.endpoints.with_raw_response.update_cluster(
                cluster_id="",
            )
