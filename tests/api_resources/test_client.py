...
class TestClient:
    ...
    @parametrize
    def test_method_whoami(self, client: Together) -> None:
        client_ = client.whoami()
        assert_matches_type(WhoamiResponse, client_, path=["response"])

    @parametrize
    def test_raw_response_whoami(self, client: Together) -> None:
    ...
    @parametrize
    def test_streaming_response_whoami(self, client: Together) -> None:
...
class TestAsyncClient:
    ...
    @parametrize
    async def test_method_whoami(self, async_client: AsyncTogether) -> None:
        client = await async_client.whoami()
        assert_matches_type(WhoamiResponse, client, path=["response"])

    @parametrize
    async def test_raw_response_whoami(self, async_client: AsyncTogether) -> None:
    ...
    @parametrize
    async def test_streaming_response_whoami(self, async_client: AsyncTogether) -> None:
