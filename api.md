...
- <code title="post /rl/training-sessions">client.rl.training_sessions.<a href="./src/together/resources/rl/training_sessions/training_sessions.py">create</a>(\*\*<a href="src/together/types/rl/training_session_create_params.py">params</a>) -> None</code>
- <code title="get /rl/training-sessions/{session_id}">client.rl.training_sessions.<a href="./src/together/resources/rl/training_sessions/training_sessions.py">retrieve</a>(session_id) -> None</code>
- <code title="get /rl/training-sessions">client.rl.training_sessions.<a href="./src/together/resources/rl/training_sessions/training_sessions.py">list</a>(\*\*<a href="src/together/types/rl/training_session_list_params.py">params</a>) -> None</code>
- <code title="post /rl/training-sessions/{session_id}:forward-backward">client.rl.training_sessions.<a href="./src/together/resources/rl/training_sessions/training_sessions.py">forward_backward</a>(session_id, \*\*<a href="src/together/types/rl/training_session_forward_backward_params.py">params</a>) -> None</code>
- <code title="post /rl/training-sessions/{session_id}:optim-step">client.rl.training_sessions.<a href="./src/together/resources/rl/training_sessions/training_sessions.py">optim_step</a>(session_id, \*\*<a href="src/together/types/rl/training_session_optim_step_params.py">params</a>) -> None</code>
- <code title="post /rl/training-sessions/{session_id}:stop">client.rl.training_sessions.<a href="./src/together/resources/rl/training_sessions/training_sessions.py">stop</a>(session_id) -> None</code>

### Operations

Methods:

- <code title="get /rl/training-sessions/{session_id}/operations/forward-backward/{operation_id}">client.rl.training_sessions.operations.<a href="./src/together/resources/rl/training_sessions/operations.py">retrieve_forward_backward</a>(operation_id, \*, session_id) -> None</code>
- <code title="get /rl/training-sessions/{session_id}/operations/optim-step/{operation_id}">client.rl.training_sessions.operations.<a href="./src/together/resources/rl/training_sessions/operations.py">retrieve_optim_step</a>(operation_id, \*, session_id) -> None</code>
