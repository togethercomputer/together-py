...
[![PyPI version](https://img.shields.io/pypi/v/togetherai-python.svg)](https://pypi.org/project/togetherai-python/)
...
```sh
# install from PyPI
pip install --pre togetherai-python
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/togetherai-python-python/issues) with questions, bugs, or suggestions.
